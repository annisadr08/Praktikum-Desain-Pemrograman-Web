                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-10 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <h6 class="text-uppercase fw-bold mb-4">
                                <i class="fas fa-gem me-3"></i>FUNTOPIA
                            </h6>
                            <p>
                                Website "Funtopia" merupakan platform online yang memudahkan para pengunjung 
                                untuk memesan tiket masuk ke berbagai wahana permainan yang ada. Website ini dilengkapi 
                                dengan tampilan yang menarik dan mudah digunakan, serta dilengkapi dengan informasi yang 
                                lengkap mengenai setiap wahana permainan.
                            </p>
                        </div>
                        <!-- Grid column -->
